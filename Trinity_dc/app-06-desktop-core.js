...
const DC_TOUR_CHAPTERS = {
  ...
  mobile: {
    hub: [
      ...
      { anchor: () => document.getElementById('wts-tabstrip'), place:'below',
        title: 'Where To Start',
        body:  'Your triage list \u2014 only trucks with active alerts, worst first. This tab strip also switches views: Overview and Components Condition live here too.' },
