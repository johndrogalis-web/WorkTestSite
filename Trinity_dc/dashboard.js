/* ╔═══════════════════════════════════════════════════════════════════════════╗
   ║  dashboard.js — DASHBOARDS bundle                                          ║
   ║  Prefixes: db-  (dashboard, widgets, layout)   dbp- (library previews)     ║
   ║  Nav item: Dashboards (desktop rail, tablet nav panel, mobile side nav)    ║
   ║                                                                            ║
   ║  This file is a straight concatenation of two former scripts, in their     ║
   ║  original load order. Nothing inside was edited. Each original starts at   ║
   ║  a FILE banner below; search for "FILE:" to jump between them.             ║
   ║                                                                            ║
   ║    1. app-13-dashboard.js        widget definitions, layout, edit mode,    ║
   ║                                  desktop / tablet / mobile mounts, vfDd    ║
   ║    2. app-22-widget-previews.js  wraps dbRenderLibrary / dbRenderDesktop / ║
   ║                                  drop handlers for previews + shelf cap    ║
   ║                                                                            ║
   ║  Load order: after app-12, before account.js (app-14..17). See             ║
   ║  STRUCTURE.md for the bundle plan and the rules for adding to this file.   ║
   ╚═══════════════════════════════════════════════════════════════════════════╝ */



/* ═══ FILE: app-13-dashboard.js ═══════════════════════════════════════════════════════ */
...
/* ═══ FILE: app-22-widget-previews.js ═════════════════════════════════════════════════ */
