...
CAT = [
 ...
 ('Avatar', 'inform', 'Informers', 'ok', '51692:17265', None,
  'Circle or squircle, four sizes. Pick one shape per product and never mix.'),
 ('Badge', 'inform', 'Informers', 'gap', '7477:297479', None,
  'Only three of six size and content combinations were drawn.'),
 ...
 ('Progress bar', 'inform', 'Informers', 'gap', '51692:17330', None,
 ...
 ('Slider', 'form', 'Form elements', 'gap', '53714:4469', None,
  'No disabled state, no focus state.'),
 ('Spinner', 'inform', 'Informers', 'ok', '10259:29263', None, 'Three sizes: 16, 24, 40.'),
 ...
 ('Tag', 'inform', 'Informers', 'gap', '56041:114', None,
  'Variants are slash-paths crammed into a single axis.'),
 ...
 ('Tooltip', 'inform', 'Informers', 'gap', '2620:4152', None,
  'Four positions. No timing, no dismissal behaviour.'),
...
<p class="lede">Every component the Trinity library contains, with an honest status on each.
   {documented} of the {len(CAT)} are covered by the twelve component pages built so far; the
